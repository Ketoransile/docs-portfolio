  ...
  return (
    <section className="pt-10 pb-20 min-h-[80vh] flex flex-col gap-10">
      <div>
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-7 text-muted-foreground tracking-tight">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-full mb-10 font-medium">
          ...
          using modern technologies like Next.js, React, and Tailwind CSS. I am
          always expanding my skills and aiming to deliver comprehensive,
...
export async function GET() {
  return NextResponse.json({ message: "Welcome to my portfolio!" }, { status: 200 });
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <a
          href="/about"
          className="flex items-center gap-1 hover:text-blue-600 transition-colors font-semibold text-base sm:text-lg"
        >
          About Me &gt;
        </a>
      </div>
